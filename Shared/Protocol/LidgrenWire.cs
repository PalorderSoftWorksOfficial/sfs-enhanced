...
namespace SFSEnhanced.Shared.Protocol
{
    public static class LidgrenWire
    {
        ...
        public const int MaxPacketBytes = NetMessage.MaxPayloadBytes + HeaderBytes;
        ...
        public static byte[] Encode(PacketType type, object payload)
        {
            ...
            if (body.Length > NetMessage.MaxPayloadBytes) throw new InvalidOperationException("Packet payload is too large.");
        ...
        public static (PacketType type, string json) Decode(byte[] data)
        {
            ...
            if (length < 0 || length > NetMessage.MaxPayloadBytes || data.Length != length + HeaderBytes) throw new InvalidOperationException("Invalid network packet length.");
